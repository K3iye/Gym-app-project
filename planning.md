# JaryAI Development Plan

## How We Split the Work

We decided to split development between the frontend and backend.

The frontend will be handled by Ryan Nguyen, focusing on Next.js,
React, TypeScript, Tailwind CSS, and MediaPipe.

The backend will be handled by Johnny Rosado Ventura, focusing on
Python, FastAPI, NumPy, and PyTorch.
